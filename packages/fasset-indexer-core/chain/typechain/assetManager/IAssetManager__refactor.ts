...
export interface IAssetManager__refactorInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IAssetManager__refactor extends BaseContract {
  connect(runner?: ContractRunner | null): IAssetManager__refactor;
  waitForDeployment(): Promise<this>;

  interface: IAssetManager__refactorInterface;
