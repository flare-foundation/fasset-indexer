...
import type {
  IAssetManager__initial,
  IAssetManager__initialInterface,
} from "../../assetManager/IAssetManager__initial";
...
export class IAssetManager__initial__factory {
  static readonly abi = _abi;
  static createInterface(): IAssetManager__initialInterface {
    return new Interface(_abi) as IAssetManager__initialInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IAssetManager__initial;
  }
}
