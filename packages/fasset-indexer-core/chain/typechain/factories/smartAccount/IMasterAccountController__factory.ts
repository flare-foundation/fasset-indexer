...
import type {
  ...
  IMasterAccountControllerInterface,
} from "../../smartAccount/IMasterAccountController";
...
const _abi = [
  ...
  {
    type: "function",
    name: "addXrplProviderWallets",
    inputs: [
      {
        name: "_xrplProviderWallets",
        type: "string[]",
        internalType: "string[]",
      },
    ],
  ...
  {
    type: "function",
    name: "removeInstructionFees",
    inputs: [
      {
        name: "_instructionIds",
        type: "uint256[]",
        internalType: "uint256[]",
      },
    ],
  ...
  {
    type: "function",
    name: "removeXrplProviderWallets",
    inputs: [
      {
        name: "_xrplProviderWallets",
        type: "string[]",
  ...
  {
    type: "function",
    name: "setDefaultInstructionFee",
    inputs: [
      {
        name: "_defaultInstructionFee",
        type: "uint256",
        internalType: "uint256",
      },
    ],
  ...
  {
    type: "function",
    name: "setPaymentProofValidityDuration",
    inputs: [
      {
        name: "_paymentProofValidityDurationSeconds",
        type: "uint256",
        internalType: "uint256",
      },
    ],
  ...
  {
    type: "function",
    name: "setPersonalAccountImplementation",
    inputs: [
      {
...
export class IMasterAccountController__factory {
  static readonly abi = _abi;
  static createInterface(): IMasterAccountControllerInterface {
    return new Interface(_abi) as IMasterAccountControllerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IMasterAccountController;
  }
}
