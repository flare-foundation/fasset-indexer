...
export class ICoreVaultManager__factory {
  static readonly abi = _abi;
  static createInterface(): ICoreVaultManagerInterface {
    return new Interface(_abi) as ICoreVaultManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ICoreVaultManager {
    return new Contract(address, _abi, runner) as unknown as ICoreVaultManager;
  }
}
