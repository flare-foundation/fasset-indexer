...
export type FeeConfigStruct = { feeBps: BigNumberish; enabled: boolean };

export type FeeConfigStructOutput = [feeBps: bigint, enabled: boolean] & {
  feeBps: bigint;
  enabled: boolean;
};
...
export interface FAssetOFTAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BPS_DENOMINATOR"
      | "SEND"
...
export namespace DefaultFeeBpsSetEvent {
...
export namespace FeeBpsSetEvent {
  export type InputTuple = [
    dstEid: BigNumberish,
    feeBps: BigNumberish,
    enabled: boolean
  ];
  export type OutputTuple = [dstEid: bigint, feeBps: bigint, enabled: boolean];
  export interface OutputObject {
    dstEid: bigint;
    feeBps: bigint;
    enabled: boolean;
...
export namespace FeeWithdrawnEvent {
  export type InputTuple = [to: AddressLike, amountLD: BigNumberish];
  export type OutputTuple = [to: string, amountLD: bigint];
  export interface OutputObject {
    to: string;
    amountLD: bigint;
  }
...
export interface FAssetOFTAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): FAssetOFTAdapter;
  waitForDeployment(): Promise<this>;

  interface: FAssetOFTAdapterInterface;
  ...
  enforcedOptions: TypedContractMethod<
    [_eid: BigNumberish, _msgType: BigNumberish],
    [string],
    "view"
  >;

  feeBalance: TypedContractMethod<[], [bigint], "view">;
  ...
  setFeeBps: TypedContractMethod<
    [_dstEid: BigNumberish, _feeBps: BigNumberish, _enabled: boolean],
    [void],
    "nonpayable"
  >;
  ...
  getEvent(
    key: "DefaultFeeBpsSet"
  ): TypedContractEvent<
    DefaultFeeBpsSetEvent.InputTuple,
    DefaultFeeBpsSetEvent.OutputTuple,
    DefaultFeeBpsSetEvent.OutputObject
  >;
  getEvent(
  ...
  getEvent(
    ...
    FeeBpsSetEvent.InputTuple,
    FeeBpsSetEvent.OutputTuple,
    FeeBpsSetEvent.OutputObject
  >;
  getEvent(
    key: "FeeWithdrawn"
  ): TypedContractEvent<
  ...
  filters: {
    "DefaultFeeBpsSet(uint16)": TypedContractEvent<
      DefaultFeeBpsSetEvent.InputTuple,
      DefaultFeeBpsSetEvent.OutputTuple,
      DefaultFeeBpsSetEvent.OutputObject
    >;
    DefaultFeeBpsSet: TypedContractEvent<
      DefaultFeeBpsSetEvent.InputTuple,
      DefaultFeeBpsSetEvent.OutputTuple,
      DefaultFeeBpsSetEvent.OutputObject
    >;
    ...
    "FeeBpsSet(uint32,uint16,bool)": TypedContractEvent<
      FeeBpsSetEvent.InputTuple,
      FeeBpsSetEvent.OutputTuple,
      FeeBpsSetEvent.OutputObject
    >;
    FeeBpsSet: TypedContractEvent<
      FeeBpsSetEvent.InputTuple,
      FeeBpsSetEvent.OutputTuple,
      FeeBpsSetEvent.OutputObject
    >;
